...
export const updateAboutPageSectionsSchema = z.object({
    hero: z.object({
        title: z.string({
            required_error: "hero title is required"
        }).min(1, "hero title is required"),
        tagline: z.string({
            required_error: "hero tagline is required"
        }).min(1, "hero tagline is required"),
