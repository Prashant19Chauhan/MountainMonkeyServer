...
export const updateDestinationDetailSectionsSchema = z.object({
    customSections: z.array(z.object({
        ...
        links: z.array(z.object({
            text: z.string({ required_error: "link text is required" }).min(1, "link text is required"),
            url: z.string({ required_error: "link url is required" }).min(1, "link url is required")
        })),
        faq: z.array(z.object({
            question: z.string({ required_error: "question is required" }).min(1, "question is required"),
            answer: z.string({ required_error: "answer is required" }).min(1, "answer is required")
        }))
    }))
});
